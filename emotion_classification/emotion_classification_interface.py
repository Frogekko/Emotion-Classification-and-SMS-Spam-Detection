...
def predict_emotions(text):
    ...
    # Get predicted emotions and their confidence scores
    ...
    # Determine sentiment for styling (simplified: positive, negative, or neutral)
    ...
    # Styled output based on sentiment
